...
module.exports = (req,res,next)=>{
    ...
    console.log(role);
    if(role !== config.userTypes.superadmin && role !== config.userTypes.departmentAdmin ) return res.status(403).json({message:"Sorry, you must have super admin or labadmin permission"})
